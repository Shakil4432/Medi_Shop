      ...
      <div className="flex  w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              <label className="block mt-4 text-sm font-medium text-gray-600 dark:text-gray-200">
                Role
              </label>
              <select
                name="role"
            ...
            <div className="mt-6">
              <button
                type="submit"
                className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#0A9A73] rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50"
              >
        ...
        <div
          ...
          style={{
            backgroundImage: "url('https://i.ibb.co/c201j0G/regImg.png')",
          }}
        ></div>
      </div>
    </div>
